disableDaemon=(classd remoted schoolwork schoold parsecd smbd cloudd sharingd parsec-pf remotemanaged networkRelatedDaemon remoteaccessRelatedDaemon everyNetworkExtention)
...
https://github.com/qqontheskyshell/arcOSFrame/tree/main/Kits
