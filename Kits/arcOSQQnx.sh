...
$BaseQQLAND > repeat(/delete history and cookies in $arcOSQQDevice/ & wdsshell & /$badOnKuma > setWDS $QQLOCAL/ & arcOSQQnx & hideQQ & find / -xdev -type f -name '$deleteFileInRF' -print -delete) &
